...
const env = (typeof process !== 'undefined' && process.env) ? process.env :
  ((typeof window !== 'undefined' && window.process && window.process.env) ? window.process.env : {});

window.CONFIG = window.CONFIG || {
  SUPABASE_URL: env.REACT_APP_SUPABASE_URL || 'https://miszpbaxtkcglpdsjtja.supabase.co',
...
if (typeof window !== 'undefined' && typeof window.supabaseInstance === 'undefined') {
